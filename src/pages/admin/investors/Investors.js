...
function Investors() {
  ...
  return (
    <div className="relative flex flex-col w-full min-w-0 mb-0 break-words bg-secondary border-0 border-transparent border-solid shadow-xl rounded-2xl bg-clip-border">
              ...
              {users.map((user, index) =>
                ...
                <tr key={index}>
                  ...
                  <td className="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-">
                    <p className="mb-0 text-s font-medium leading-tight text-center font-main opacity-80">{user.numberOfTransactions}</p>
                  </td>
                  <td className="p-2 text-sm leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <p className="mb-0 text-s font-medium leading-tight text-center font-main opacity-80">{user.totalInvestment}</p>
                  </td>
                  <td className="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                    <p className="mb-0 text-s font-medium leading-tight text-center font-main opacity-80">{user.currentBalance}</p>
                  </td>
                  <td className="p-2 align-middle border-b whitespace-nowrap shadow-transparent">
                    <a className="px-4 py-2 text-s font-semibold leading-tight rounded-lg bg-success text-primary font-main">view</a>
                  </td>
