...
function Company() {
  ...
  return (
    <div>
      <div className="flex flex-wrap items-center w-full h-56 justify-evenly pt-10">
      ...
      <div className="flex py-4 text-primary">
        <button className="py-3 px-8 mx-auto text-lg font-medium capitalize bg-accent rounded-xl">
          invest now
        </button>
      </div>
    </div>
