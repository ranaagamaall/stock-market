    ...
    >
        <div className="p-5">
            <div className="flex justify-between">
                ...
                <div className={`${getPercentage(props.stat.number) > 0 ? "bg-success" : "bg-fail"} rounded-full h-6 px-2 flex justify-items-center text-primary font-main font-semibold text-sm`}>
